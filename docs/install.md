...
## Vonk Ultra Atom Packages

Vonk Ultra is a free open-source (GPL v3) toolset. It is distributed through the [Reactor Package Manager](https://gitlab.com/WeSuckLess/Reactor) for Resolve Studio/Fusion Studio. Install the Reactor package manager, and select the "Kartaverse/Vonk Ultra" category on the left side of the Reactor GUI to access the tools. Then install the "Vonk Ultra" and "Vonk | FusionMograph" packages.
...
> To start using Vonk Ultra for BMD Resolve Studio/Fusion Studio you need to get the [Reactor Package Manager](https://gitlab.com/WeSuckLess/Reactor) setup on your system. 
